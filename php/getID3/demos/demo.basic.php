...
$ThisFileInfo = $getID3->analyze("/var/www/html/audio/music/ABBA/Gold/Fernando.mp3");
...
//echo $ThisFileInfo['comments_html']['title'][0];
//echo $ThisFileInfo['comments_html']['album'][0];
//echo $ThisFileInfo['comments_html']['track_number'][0];
