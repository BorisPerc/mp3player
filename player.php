...
<head>
	...
	<link rel="icon" type="image/png" href="img/saw.png"><!-- tab & bookmarks icon -->
	<link rel="apple-touch-icon" href="img/saw.png"><!-- home shortcut icon apple -->
	<link rel="shortcut icon" href="img/saw.png"><!-- home shortcut icon android -->
	<link rel="apple-touch-startup-image" href="img/saw.png"><!-- splash screen -->
	<meta name="apple-mobile-web-app-status-bar-style" content="black">
	<meta name="apple-mobile-web-app-title" content="PSMedia"><!-- home shortcut title apple -->
	...
	<!-- BUZZSAW audio server (c) Audio Server 2017 -->
</head>
<body>
	...
	<div id="bottombar">
		...
		<div id="controls" class="albumtooltip">
			<button id="btnPrev" class="roundButton roundButtonSmall" onClick="nextTrack(false);" onfocus="controlButton_onFocus();" onblur="controlButton_lostFocus();">⏪</button>
			...
			<button id="btnNext" class="roundButton roundButtonSmall" onClick="nextTrack(true);" onfocus="controlButton_onFocus();" onblur="controlButton_lostFocus();">⏩</button>
			<?php if($currentAlbum!="") { ?>
